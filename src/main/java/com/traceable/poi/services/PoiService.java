...
import com.traceable.poi.model.*;
...
public class PoiService {
    ...
    private final PointInterestRepository interestRepository;

    private final ParkingTimeRepository parkingTimeRepository;


    public PoiService(MeetingRepository meetingRepository, PositionRepository positionRepository,
                      PointInterestRepository interestRepository, ParkingTimeRepository parkingTimeRepository) {
            ...
            for (Position position : positions) {
                if (verifyMeeting(position, inter)) {
                    ...
                    try {
                        ...
                        LOG.error("Exception on save: {0} ", e);
     ...
     * @param interests         Método que calcula em minutos, o quanto cada carro ficoudentro de um ponto
     */
